...
namespace skidle_md.Libs
{
    public class HighLighting
    {
        ...
        public void _HighLighting(object sender, TextChangedEventArgs e)
        {
            ...
            e.ChangedRange.SetStyle(TealStyle, @"Add|var");
            ...
            e.ChangedRange.SetStyle(MediumPurpleStyle, @"input|out|Null|True|False|protected:|private:");
